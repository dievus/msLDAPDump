...
def ldap_search():
    try:
        ...
        if username == 'y' or username == 'Y':
            ...
            if password == 'y' or password == 'Y':
                ...
                try:
                    ...
                    if hostname is not None:
                        print(success + '[success] Target hostname is ' + hostname + '\n' + close)
                    ...
                    print(fail + '[error] Unable to contact target host. Quitting...\n' + close)
                    quit()
                ...
                conn.unbind()
                print(
                    '[info] All set for now. Come back with credentials to dump additional domain information.\n')
                quit()
            ...
            conn.unbind()
            print(
                info + '[info] All set for now. Come back with credentials to dump additional domain information.\n' + close)
            quit()
        else:
            print(
        ...
        try:
            ...
            if hostname is not None:
                ...
                print(info + '[info] Could not identify target hostname. Continuing...\n' + close)
                hostname = dom_con
        except Exception:
            print(fail + '[error] Unable to contact target host. Quitting...\n' + close)
            quit()
        if username == 'n' or username == 'N' or password == 'n' or password == 'N':
            print(info + '[info] End of the line. Once you have credentials you can authenticate and dump additional information.\n' + close)
            quit()
